...
//            result.randIndex = (a + b) /(float) (a + b + c + d);
            if(consideredClusters>0)
                resTable.Rows.Add(consideredClusters.ToString(),name, String.Format("{0:0.####}", (c + d) / ED * EA / a), String.Format("{0:0.####}", (a + b) / (float)(a + b + c + d)));
            else
                resTable.Rows.Add("All",name, String.Format("{0:0.####}", (c + d) / ED * EA / a), String.Format("{0:0.####}", (a + b) / (float)(a + b + c + d)));
