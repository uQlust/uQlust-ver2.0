...
{
    public delegate void UpdateJob(string item,bool errorFlag=false);
    ...
    public class JobManager
    {
        ...
        {           
            ...
            UpadateJobInfo(name, false);
        }
        public void UpadateJobInfo(string processName, bool errorFlag)
        {
            if (updateJob != null)
                updateJob(processName, errorFlag);
        ...
        public void FinishThread(string processName,bool errorFlag)
        {
            lock (runnigThreads)
            {
                UpadateJobInfo(currentProcessName, errorFlag);
                                                      ...
                                                      string profileName = null, string refJuryProfile = null)
        {
            ...
            if (measure == DistanceMeasures.HAMMING)
            {
                ...
                if (measure == DistanceMeasures.RMSD)
                {
